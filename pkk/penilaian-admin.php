...
<a class='btn text-white' href="addpenilaian.php" style="float: right; background-color :#468B97">Tambahkan Data Baru</a><br /><br />
<table>
  <tr>
  ...
  if (isset($result) && $result->num_rows > 0) {
    while ($row = $result->fetch_assoc()) {
      echo "<tr>
                ...
                <td>"  . $row["Ket3"] . "</td>
                <td>" . $row["Ket4"] . "</td>
                <td><a class='btn btn-warning' href='editpenilaian.php?No_Urut=$row[No_Urut]'>Edit</a>
                    <a class='btn btn-danger' href='deletepenilaian.php?No_Urut=$row[No_Urut]'>Delete</a></td>
           </tr>";
    }
  } else {
